...
class Manager
{
     ...
     * 构造函数
     */
    public function __construct(array $configs, ?string $proxy = null)
    {
        $this->cluster = new Cluster($configs, $proxy ?? Proxy::class);
    }

    /**
     * 获取连接
     */
    public function connection(string $key = null, string $group = 'slave') : mixed
    {
